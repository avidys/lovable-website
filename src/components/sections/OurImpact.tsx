...
const OurImpact = () => {
  ...
  return (
    <section id="impact" ref={ref} className="py-24 relative overflow-hidden bg-gradient-to-br from-background via-muted/20 to-background">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_30%_50%,rgba(34,197,94,0.1)_0%,transparent_50%)]" />
        ...
        <div className="text-center">
          <div className={`inline-block px-8 py-6 rounded-2xl bg-card/50 backdrop-blur-sm border-2 border-dashed border-primary/30 transition-all duration-700 ${isVisible ? 'animate-scale-in' : 'opacity-0 scale-95'}`} style={{ animationDelay: "0.2s" }}>
            <p className="text-muted-foreground text-lg">
              Impact metrics and case studies to be provided
            </p>
          </div>
        </div>
      </div>
